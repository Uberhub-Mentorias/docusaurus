...
const config = {
  ...
  url: 'https://angoti.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/mentorias-frontend/',

  // GitHub pages deployment config.
  organizationName: 'angoti', // Usually your GitHub org/user name.
  projectName: 'mentorias-frontend', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/angoti/mentorias-frontend/tree/main/docusaurus/',
        },
