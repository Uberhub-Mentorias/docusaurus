...
1. [Auth Service](#auth-service) - 10 endpoints - Autenticação e Gerenciamento de Usuários
2. [Profile Service](#profile-service) - 9 endpoints - Perfis de Mentores e Tags
3. [Matchmaking Service](#matchmaking-service) - 4 endpoints - Algoritmo de Compatibilidade
4. [Mentorship Service](#mentorship-service) - 9 endpoints - Mentorias
5. [Admin Service](#admin-service) - 23 endpoints - Administração, Analytics e Vouchers

---

## 🔗 Índice de Endpoints com Links para Código

Este índice permite navegar diretamente para o código de implementação de cada endpoint.

### Auth Service

| Método | Endpoint | Arquivo | Método | Linhas |
|--------|----------|---------|--------|--------|
| `POST` | `/auth/register` | [`AuthController.java`](../../backend/auth-service/src/main/java/com/example/auth/api/AuthController.java) | `register()` | ~87 |
| `POST` | `/auth/login` | [`AuthController.java`](../../backend/auth-service/src/main/java/com/example/auth/api/AuthController.java) | `login()` | ~120 |
| `POST` | `/auth/refresh` | [`AuthController.java`](../../backend/auth-service/src/main/java/com/example/auth/api/AuthController.java) | `refresh()` | ~150 |
| `POST` | `/auth/recover-password` | [`AuthController.java`](../../backend/auth-service/src/main/java/com/example/auth/api/AuthController.java) | `recoverPassword()` | ~180 |
| `GET` | `/users/me` | [`AuthController.java`](../../backend/auth-service/src/main/java/com/example/auth/api/AuthController.java) | `getMe()` | ~200 |
| `PUT` | `/users/me/fcm-token` | [`AuthController.java`](../../backend/auth-service/src/main/java/com/example/auth/api/AuthController.java) | `updateFcmToken()` | ~220 |
| `GET` | `/users` | [`AuthController.java`](../../backend/auth-service/src/main/java/com/example/auth/api/AuthController.java) | `listUsers()` | ~240 |
| `PUT` | `/users/{id}/status` | [`AuthController.java`](../../backend/auth-service/src/main/java/com/example/auth/api/AuthController.java) | `updateUserStatus()` | ~258 |
| `PUT` | `/users/{userId}/credit` | [`AuthController.java`](../../backend/auth-service/src/main/java/com/example/auth/api/AuthController.java) | `updateUserCredit()` | ~275 |
| `PUT` | `/users/{userId}/add-role` | [`AuthController.java`](../../backend/auth-service/src/main/java/com/example/auth/api/AuthController.java) | `addRole()` | ~283 |
| `GET` | `/users/{userId}/fcm-token` | [`AuthController.java`](../../backend/auth-service/src/main/java/com/example/auth/api/AuthController.java) | `getFcmToken()` | ~325 |

### Profile Service

| Método | Endpoint | Arquivo | Método | Linhas |
|--------|----------|---------|--------|--------|
| `POST` | `/profiles/mentor` | [`ProfileController.java`](../../backend/profile-service/src/main/java/com/example/profile/api/ProfileController.java) | `createMentorProfile()` | ~114 |
| `PUT` | `/profiles/mentor` | [`ProfileController.java`](../../backend/profile-service/src/main/java/com/example/profile/api/ProfileController.java) | `updateMentorProfile()` | ~148 |
| `GET` | `/profiles/mentor/{mentorId}` | [`ProfileController.java`](../../backend/profile-service/src/main/java/com/example/profile/api/ProfileController.java) | `getMentorProfile()` | ~178 |
| `GET` | `/profiles/mentors` | [`ProfileController.java`](../../backend/profile-service/src/main/java/com/example/profile/api/ProfileController.java) | `listMentors()` | ~191 |
| `GET` | `/profiles/mentors/pending` | [`ProfileController.java`](../../backend/profile-service/src/main/java/com/example/profile/api/ProfileController.java) | `listPendingMentors()` | ~221 |
| `PUT` | `/profiles/mentor/{mentorId}/status` | [`ProfileController.java`](../../backend/profile-service/src/main/java/com/example/profile/api/ProfileController.java) | `updateProfileStatus()` | ~235 |
| `GET` | `/tags` | [`ProfileController.java`](../../backend/profile-service/src/main/java/com/example/profile/api/ProfileController.java) | `listTags()` | ~270 |
| `POST` | `/tags` | [`ProfileController.java`](../../backend/profile-service/src/main/java/com/example/profile/api/ProfileController.java) | `createTag()` | ~282 |
| `PUT` | `/tags/{tagId}` | [`ProfileController.java`](../../backend/profile-service/src/main/java/com/example/profile/api/ProfileController.java) | `updateTag()` | ~299 |
| `DELETE` | `/tags/{tagId}` | [`ProfileController.java`](../../backend/profile-service/src/main/java/com/example/profile/api/ProfileController.java) | `deleteTag()` | ~323 |

### Matchmaking Service

| Método | Endpoint | Arquivo | Método | Linhas |
|--------|----------|---------|--------|--------|
| `POST` | `/matchmaking` | [`MatchmakingController.java`](../../backend/matchmaking-service/src/main/java/com/example/matchmaking/api/MatchmakingController.java) | `findMatch()` | ~50 |
| `POST` | `/matchmaking/batch` | [`MatchmakingController.java`](../../backend/matchmaking-service/src/main/java/com/example/matchmaking/api/MatchmakingController.java) | `findMatchesBatch()` | ~80 |
| `POST` | `/matchmaking/score` | [`MatchmakingController.java`](../../backend/matchmaking-service/src/main/java/com/example/matchmaking/api/MatchmakingController.java) | `calculateScore()` | ~110 |
| `GET` | `/matchmaking/decisions/{menteeId}` | [`MatchmakingController.java`](../../backend/matchmaking-service/src/main/java/com/example/matchmaking/api/MatchmakingController.java) | `getMatchingDecisions()` | ~140 |

### Mentorship Service

| Método | Endpoint | Arquivo | Método | Linhas |
|--------|----------|---------|--------|--------|
| `POST` | `/mentorships` | [`MentorshipController.java`](../../backend/mentorship-service/src/main/java/com/example/mentorship/api/MentorshipController.java) | `createMentorship()` | ~100 |
| `GET` | `/mentorships/mentee` | [`MentorshipController.java`](../../backend/mentorship-service/src/main/java/com/example/mentorship/api/MentorshipController.java) | `listMenteeMentorships()` | ~200 |
| `GET` | `/mentorships/mentor` | [`MentorshipController.java`](../../backend/mentorship-service/src/main/java/com/example/mentorship/api/MentorshipController.java) | `listMentorMentorships()` | ~250 |
| `PUT` | `/mentorships/{id}/status` | [`MentorshipController.java`](../../backend/mentorship-service/src/main/java/com/example/mentorship/api/MentorshipController.java) | `updateMentorshipStatus()` | ~300 |
| `PUT` | `/mentorships/{id}/schedule` | [`MentorshipController.java`](../../backend/mentorship-service/src/main/java/com/example/mentorship/api/MentorshipController.java) | `scheduleSession()` | ~350 |
| `POST` | `/mentorships/{id}/schedule/confirm` | [`MentorshipController.java`](../../backend/mentorship-service/src/main/java/com/example/mentorship/api/MentorshipController.java) | `confirmSchedule()` | ~400 |
| `POST` | `/mentorships/{id}/feedback/mentor` | [`MentorshipController.java`](../../backend/mentorship-service/src/main/java/com/example/mentorship/api/MentorshipController.java) | `submitMentorFeedback()` | ~450 |
| `POST` | `/mentorships/{id}/feedback/mentee` | [`MentorshipController.java`](../../backend/mentorship-service/src/main/java/com/example/mentorship/api/MentorshipController.java) | `submitMenteeFeedback()` | ~500 |
| `POST` | `/mentorships/{id}/request-change` | [`MentorshipController.java`](../../backend/mentorship-service/src/main/java/com/example/mentorship/api/MentorshipController.java) | `requestChange()` | ~550 |

### Admin Service

| Método | Endpoint | Arquivo | Método | Linhas |
|--------|----------|---------|--------|--------|
| `GET` | `/admin/dashboard` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `getDashboard()` | ~110 |
| `GET` | `/admin/mentors/pending` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `getPendingMentors()` | ~146 |
| `POST` | `/admin/mentors/{id}/approve` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `approveMentor()` | ~158 |
| `GET` | `/admin/users` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `listUsers()` | ~146 |
| `POST` | `/admin/users/{id}/suspend` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `suspendUser()` | ~151 |
| `GET` | `/admin/vouchers` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `listVouchers()` | ~171 |
| `GET` | `/admin/vouchers/{id}` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `getVoucherById()` | ~195 |
| `GET` | `/admin/vouchers/code/{code}` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `getVoucherByCode()` | ~208 |
| `POST` | `/admin/vouchers` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `createVoucher()` | ~221 |
| `POST` | `/admin/vouchers/generate` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `generateVouchers()` | ~252 |
| `PUT` | `/admin/vouchers/{id}` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `updateVoucher()` | ~289 |
| `DELETE` | `/admin/vouchers/{id}` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `deleteVoucher()` | ~329 |
| `GET` | `/admin/vouchers/validate/{code}` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `validateVoucher()` | ~355 |
| `POST` | `/admin/vouchers/redeem` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `redeemVoucher()` | ~377 |
| `GET` | `/admin/mentorships/change-requests` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `getChangeRequests()` | ~414 |
| `POST` | `/admin/mentorships/change-requests/{id}/approve` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `approveChangeRequest()` | ~419 |
| `GET` | `/admin/tags` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `listTags()` | ~434 |
| `POST` | `/admin/tags` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `createTag()` | ~439 |
| `PUT` | `/admin/tags/{tagId}` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `updateTag()` | ~452 |
| `DELETE` | `/admin/tags/{tagId}` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `deleteTag()` | ~458 |
| `GET` | `/admin/logs` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `getLogs()` | ~N/A |
| `POST` | `/analytics/record-event` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `recordEvent()` | ~464 |
| `POST` | `/notifications/send` | [`AdminController.java`](../../backend/admin-service/src/main/java/com/example/admin/api/AdminController.java) | `sendNotification()` | ~474 |

**Nota:** Os números de linha são aproximados e podem variar conforme o código evolui. Use a busca no arquivo (Ctrl+F / Cmd+F) pelo nome do método para localização precisa.
