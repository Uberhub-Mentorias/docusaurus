...
- **Heroku**: Plataforma de deploy recomendada (custo baixo, porém app 'adormece')
...
> **📖 Veja ENV_CONFIGURATION.md para explicação detalhada sobre MONGODB_URI**
...
| Documento                                                                                   | Descrição                                 |
| ------------------------------------------------------------------------------------------- | ----------------------------------------- |
| [Arquitetura v2.md](Arquitetura%20v2.md)                                                    | Arquitetura completa do sistema           |
| [Endpoints.md](Endpoints.md)                                                                | Lista de todos os endpoints da API        |
| [Especificação de Requisitos](Especificação%20de%20Requisitos%20-%20UberHub%20Mentorias.md) | Casos de uso e requisitos                 |
| [FLUXOS-JORNADAS-OPERACOES.md](FLUXOS-JORNADAS-OPERACOES.md)                                | Fluxos de navegação e jornadas do usuário |

### Documentação de Infraestrutura

| Documento               | Descrição                                |
| ----------------------- | ---------------------------------------- |
| DEPLOY-QUICK-START.md   | Guia rápido de deploy no Railway (5 min) |
| DEPLOY.md               | Guia completo de deploy                  |
| MONGODB-INSTALLATION.md | Instalação e configuração do MongoDB     |
| GUIA-DEFINITIVO-LOGS.md | Sistema de logs                          |

### Documentação Mobile

| Documento          | Descrição                    |
| ------------------ | ---------------------------- |
| ARCHITECTURE.md    | Arquitetura dos apps mobile  |
| API_INTEGRATION.md | Integração com a API         |
...
Consulte o Guia Rápido de Deploy (DEPLOY-QUICK-START.md)
...
Ver documentação completa: [Endpoints.md](Endpoints.md)
...
- **Equipe A**: Auth Service e Profile Service
- **Equipe B**: Matchmaking Service e Mentorship Service
- **Equipe C**: Admin Service e API Gateway
